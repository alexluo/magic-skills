---
name: mgc-multi-language-multi-language-gen
description: Generate multi-language support
category: multi-language
version: 1.0.0
tags: ['multi-language', 'internationalization']
...
# Generate multi-language support

## 触发条件

**自然语言：**
- "翻译 multi-language-gen"
- "本地化 multi-language-gen"
- "生成多语言 multi-language-gen"
...
### 步骤 1: 理解需求
You are an expert in multi-language. Help with: Generate multi-language support
