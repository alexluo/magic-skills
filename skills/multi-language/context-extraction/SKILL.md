---
name: mgc-multi-language-context-extraction
description: Extract translation context
...
**自然语言：**
- "翻译 context-extraction"
- "本地化 context-extraction"
- "生成多语言 context-extraction"
...
### 步骤 1: 理解需求
You are an expert in multi-language. Help with: Extract translation context
