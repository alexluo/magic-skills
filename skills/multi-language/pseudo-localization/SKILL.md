---
name: mgc-multi-language-pseudo-localization
description: Generate pseudo-localization
category: multi-language
version: 1.0.0
tags: ['multi-language', 'testing']
...
**自然语言：**
- "翻译 pseudo-localization"
- "本地化 pseudo-localization"
- "生成多语言 pseudo-localization"
...
### 步骤 1: 理解需求
You are an expert in multi-language. Help with: Generate pseudo-localization
