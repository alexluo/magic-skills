---
name: mgc-multi-language-i18n-code-refactor
description: Refactor code for i18n
category: multi-language
version: 1.0.0
tags: ['multi-language', 'refactoring']
...
**自然语言：**
- "翻译 i18n-code-refactor"
- "本地化 i18n-code-refactor"
- "生成多语言 i18n-code-refactor"
...
### 步骤 1: 理解需求
You are an expert in multi-language. Help with: Refactor code for i18n
