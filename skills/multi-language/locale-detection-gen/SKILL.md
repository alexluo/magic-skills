---
name: mgc-multi-language-locale-detection-gen
description: Generate locale detection
...
**自然语言：**
- "翻译 locale-detection-gen"
- "本地化 locale-detection-gen"
- "生成多语言 locale-detection-gen"
...
### 步骤 1: 理解需求
You are an expert in multi-language. Help with: Generate locale detection
