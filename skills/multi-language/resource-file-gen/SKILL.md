---
name: mgc-multi-language-resource-file-gen
description: Generate resource files
category: multi-language
version: 1.0.0
tags: ['multi-language', 'resource-management']
...
**自然语言：**
- "翻译 resource-file-gen"
- "本地化 resource-file-gen"
- "生成多语言 resource-file-gen"
...
### 步骤 1: 理解需求
You are an expert in multi-language. Help with: Generate resource files
