---
name: mgc-multi-language-number-format-localization
description: Localize number formats
...
**自然语言：**
- "翻译 number-format-localization"
- "本地化 number-format-localization"
- "生成多语言 number-format-localization"
...
### 步骤 1: 理解需求
You are an expert in multi-language. Help with: Localize number formats
