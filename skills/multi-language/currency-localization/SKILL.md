---
name: mgc-multi-language-currency-localization
description: Localize currency
...
**自然语言：**
- "翻译 currency-localization"
- "本地化 currency-localization"
- "生成多语言 currency-localization"
...
### 步骤 1: 理解需求
You are an expert in multi-language. Help with: Localize currency
