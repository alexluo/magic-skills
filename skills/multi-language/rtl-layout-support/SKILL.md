---
name: mgc-multi-language-rtl-layout-support
description: Add RTL layout support
...
**自然语言：**
- "翻译 rtl-layout-support"
- "本地化 rtl-layout-support"
- "生成多语言 rtl-layout-support"
...
### 步骤 1: 理解需求
You are an expert in multi-language. Help with: Add RTL layout support
