---
name: mgc-multi-language-ui-string-translate
...
**自然语言：**
- "翻译 ui-string-translate"
- "本地化 ui-string-translate"
- "生成多语言 ui-string-translate"
...
### 步骤 1: 理解需求
You are an expert in multi-language. Help with: Translate UI strings
