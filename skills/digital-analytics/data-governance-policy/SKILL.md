---
name: mgc-digital-analytics-data-governance-policy
description: Create data governance policies
category: digital-analytics
version: 1.0.0
tags: ['digital-analytics', 'governance']
...
**自然语言：**
- "分析 data-governance-policy"
- "生成 data-governance-policy 报告"
- "创建 data-governance-policy"
...
### 步骤 1: 理解需求
You are an expert in digital-analytics. Help with: Create data governance policies
