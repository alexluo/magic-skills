---
name: mgc-digital-analytics-predictive-model-gen
description: Generate predictive models
category: digital-analytics
version: 1.0.0
tags: ['digital-analytics', 'machine-learning']
...
**自然语言：**
- "分析 predictive-model-gen"
- "生成 predictive-model-gen 报告"
- "创建 predictive-model-gen"
...
### 步骤 1: 理解需求
You are an expert in digital-analytics. Help with: Generate predictive models
