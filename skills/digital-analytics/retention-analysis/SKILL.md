---
name: mgc-digital-analytics-retention-analysis
...
**自然语言：**
- "分析 retention-analysis"
- "生成 retention-analysis 报告"
- "创建 retention-analysis"
...
### 步骤 1: 理解需求
You are an expert in digital-analytics. Help with: Analyze user retention
