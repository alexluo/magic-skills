---
name: mgc-digital-analytics-user-behavior-analysis
description: Analyze user behavior patterns
category: digital-analytics
version: 1.0.0
tags: ['digital-analytics', 'analytics']
...
**自然语言：**
- "分析 user-behavior-analysis"
- "生成 user-behavior-analysis 报告"
- "创建 user-behavior-analysis"
...
### 步骤 1: 理解需求
You are an expert in digital-analytics. Help with: Analyze user behavior patterns
