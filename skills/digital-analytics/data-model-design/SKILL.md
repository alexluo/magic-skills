---
name: mgc-digital-analytics-data-model-design
description: Design data models
category: digital-analytics
version: 1.0.0
tags: ['digital-analytics', 'data-modeling']
...
**自然语言：**
- "分析 data-model-design"
- "生成 data-model-design 报告"
- "创建 data-model-design"
...
### 步骤 1: 理解需求
You are an expert in digital-analytics. Help with: Design data models
