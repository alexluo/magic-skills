---
name: mgc-digital-analytics-anomaly-detection
...
**自然语言：**
- "分析 anomaly-detection"
- "生成 anomaly-detection 报告"
- "创建 anomaly-detection"
...
### 步骤 1: 理解需求
You are an expert in digital-analytics. Help with: Detect data anomalies
