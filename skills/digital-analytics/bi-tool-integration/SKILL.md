---
name: mgc-digital-analytics-bi-tool-integration
description: Integrate BI tools
category: digital-analytics
version: 1.0.0
tags: ['digital-analytics', 'integration']
...
**自然语言：**
- "分析 bi-tool-integration"
- "生成 bi-tool-integration 报告"
- "创建 bi-tool-integration"
...
### 步骤 1: 理解需求
You are an expert in digital-analytics. Help with: Integrate BI tools
