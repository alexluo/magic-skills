---
name: mgc-digital-analytics-metrics-definition
...
**自然语言：**
- "分析 metrics-definition"
- "生成 metrics-definition 报告"
- "创建 metrics-definition"
...
### 步骤 1: 理解需求
You are an expert in digital-analytics. Help with: Define business metrics
