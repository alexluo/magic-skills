---
name: mgc-digital-analytics-custom-metric-gen
...
**自然语言：**
- "分析 custom-metric-gen"
- "生成 custom-metric-gen 报告"
- "创建 custom-metric-gen"
...
### 步骤 1: 理解需求
You are an expert in digital-analytics. Help with: Generate custom metrics
