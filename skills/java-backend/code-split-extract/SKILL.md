---
name: mgc-java-backend-code-split-extract
description: Split and extract code
category: java-backend
version: 1.0.0
tags: ['java-backend', 'refactoring']
...
**自然语言：**
- "创建 code-split-extract"
- "生成 code-split-extract"
- "写个 code-split-extract"
- "添加 code-split-extract"
