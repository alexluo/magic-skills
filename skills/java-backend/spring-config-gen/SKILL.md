---
name: mgc-java-backend-spring-config-gen
description: Generate Spring configuration
...
**自然语言：**
- "创建 spring-config-gen"
- "生成 spring-config-gen"
- "写个 spring-config-gen"
- "添加 spring-config-gen"
