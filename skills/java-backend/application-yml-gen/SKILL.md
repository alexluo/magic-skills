---
name: mgc-java-backend-application-yml-gen
description: Generate application.yml
...
**自然语言：**
- "创建 application-yml-gen"
- "生成 application-yml-gen"
- "写个 application-yml-gen"
- "添加 application-yml-gen"
