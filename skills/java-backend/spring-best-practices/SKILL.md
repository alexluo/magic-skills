---
name: mgc-java-backend-spring-best-practices
description: Check Spring best practices
category: java-backend
version: 1.0.0
tags: ['java-backend', 'code-analysis']
...
**自然语言：**
- "创建 spring-best-practices"
- "生成 spring-best-practices"
- "写个 spring-best-practices"
- "添加 spring-best-practices"
