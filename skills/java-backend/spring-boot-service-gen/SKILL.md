---
name: mgc-java-backend-spring-boot-service-gen
description: Generate Spring Boot Service layer code
...
**自然语言：**
- "创建 spring-boot-service-gen"
- "生成 spring-boot-service-gen"
- "写个 spring-boot-service-gen"
- "添加 spring-boot-service-gen"
