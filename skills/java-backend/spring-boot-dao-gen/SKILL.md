---
name: mgc-java-backend-spring-boot-dao-gen
description: Generate DAO/Repository layer code
...
**自然语言：**
- "创建 spring-boot-dao-gen"
- "生成 spring-boot-dao-gen"
- "写个 spring-boot-dao-gen"
- "添加 spring-boot-dao-gen"
