---
name: mgc-java-backend-logback-config-gen
description: Generate Logback configuration
...
**自然语言：**
- "创建 logback-config-gen"
- "生成 logback-config-gen"
- "写个 logback-config-gen"
- "添加 logback-config-gen"
