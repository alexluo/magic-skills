---
name: mgc-java-backend-swagger-model-gen
description: Generate Swagger models
...
**自然语言：**
- "创建 swagger-model-gen"
- "生成 swagger-model-gen"
- "写个 swagger-model-gen"
- "添加 swagger-model-gen"
