---
name: mgc-java-backend-spring-boot-controller-gen
description: Generate Spring Boot REST Controller code
category: java-backend
version: 1.0.0
tags: ['java-backend', 'code-generation']
...
**自然语言：**
- "创建 spring-boot-controller-gen"
- "生成 spring-boot-controller-gen"
- "写个 spring-boot-controller-gen"
- "添加 spring-boot-controller-gen"
