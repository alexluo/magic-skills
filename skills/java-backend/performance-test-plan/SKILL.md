---
name: mgc-java-backend-performance-test-plan
description: Generate performance test plans
category: java-backend
version: 1.0.0
tags: ['java-backend', 'testing']
...
**自然语言：**
- "创建 performance-test-plan"
- "生成 performance-test-plan"
- "写个 performance-test-plan"
- "添加 performance-test-plan"
