---
name: mgc-android-os-property-config-gen
description: Generate property configurations
category: android-os
version: 1.0.0
tags: ['android-os', 'system-configuration']
...
**自然语言：**
- "创建 property-config-gen"
- "生成 Android property-config-gen"
- "AOSP property-config-gen"
...
### 步骤 1: 理解需求
You are an expert in android-os. Help with: Generate property configurations
