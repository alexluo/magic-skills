---
name: mgc-android-os-binder-stub-gen
description: Generate Binder stub code
category: android-os
version: 1.0.0
...
**自然语言：**
- "创建 binder-stub-gen"
- "生成 Android binder-stub-gen"
- "AOSP binder-stub-gen"
...
### 步骤 1: 理解需求
You are an expert in android-os. Help with: Generate Binder stub code
