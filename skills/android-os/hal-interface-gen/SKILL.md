---
name: mgc-android-os-hal-interface-gen
description: Generate HAL interface definitions
category: android-os
version: 1.0.0
...
**自然语言：**
- "创建 hal-interface-gen"
- "生成 Android hal-interface-gen"
- "AOSP hal-interface-gen"
...
### 步骤 1: 理解需求
You are an expert in android-os. Help with: Generate HAL interface definitions
