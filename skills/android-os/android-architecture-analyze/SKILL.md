---
name: mgc-android-os-android-architecture-analyze
description: Analyze Android architecture
category: android-os
version: 1.0.0
tags: ['android-os', 'code-analysis']
...
**自然语言：**
- "创建 android-architecture-analyze"
- "生成 Android android-architecture-analyze"
- "AOSP android-architecture-analyze"
...
### 步骤 1: 理解需求
You are an expert in android-os. Help with: Analyze Android architecture
