---
name: mgc-android-os-sepolicy-analysis
description: Analyze SELinux policies
category: android-os
version: 1.0.0
...
**自然语言：**
- "创建 sepolicy-analysis"
- "生成 Android sepolicy-analysis"
- "AOSP sepolicy-analysis"
...
### 步骤 1: 理解需求
You are an expert in android-os. Help with: Analyze SELinux policies
