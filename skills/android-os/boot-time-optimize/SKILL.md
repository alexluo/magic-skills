---
name: mgc-android-os-boot-time-optimize
description: Optimize boot time
category: android-os
version: 1.0.0
...
**自然语言：**
- "创建 boot-time-optimize"
- "生成 Android boot-time-optimize"
- "AOSP boot-time-optimize"
...
### 步骤 1: 理解需求
You are an expert in android-os. Help with: Optimize boot time
