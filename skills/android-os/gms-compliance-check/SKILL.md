---
name: mgc-android-os-gms-compliance-check
description: Check GMS compliance
category: android-os
version: 1.0.0
...
# Check GMS compliance

## 触发条件

**自然语言：**
- "创建 gms-compliance-check"
- "生成 Android gms-compliance-check"
- "AOSP gms-compliance-check"
...
### 步骤 1: 理解需求
You are an expert in android-os. Help with: Check GMS compliance
