---
name: mgc-android-os-device-tree-gen
description: Generate device tree configurations
category: android-os
version: 1.0.0
...
**自然语言：**
- "创建 device-tree-gen"
- "生成 Android device-tree-gen"
- "AOSP device-tree-gen"
...
### 步骤 1: 理解需求
You are an expert in android-os. Help with: Generate device tree configurations
