---
name: mgc-android-os-memory-leak-detector
...
**自然语言：**
- "创建 memory-leak-detector"
- "生成 Android memory-leak-detector"
- "AOSP memory-leak-detector"
...
### 步骤 1: 理解需求
You are an expert in android-os. Help with: Detect memory leaks
