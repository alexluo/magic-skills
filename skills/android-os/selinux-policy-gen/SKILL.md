---
name: mgc-android-os-selinux-policy-gen
description: Generate SELinux policies
category: android-os
version: 1.0.0
tags: ['android-os', 'security']
...
**自然语言：**
- "创建 selinux-policy-gen"
- "生成 Android selinux-policy-gen"
- "AOSP selinux-policy-gen"
...
### 步骤 1: 理解需求
You are an expert in android-os. Help with: Generate SELinux policies
