---
name: mgc-android-os-treble-compliance-check
description: Check Treble compliance
category: android-os
version: 1.0.0
tags: ['android-os', 'compliance']
...
# Check Treble compliance

## 触发条件

**自然语言：**
- "创建 treble-compliance-check"
- "生成 Android treble-compliance-check"
- "AOSP treble-compliance-check"
...
### 步骤 1: 理解需求
You are an expert in android-os. Help with: Check Treble compliance
