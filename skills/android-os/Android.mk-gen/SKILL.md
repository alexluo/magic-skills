---
name: mgc-android-os-Android.mk-gen
description: Generate Android.mk build files
category: android-os
version: 1.0.0
...
### 步骤 1: 理解需求
You are an expert in android-os. Help with: Generate Android.mk build files
