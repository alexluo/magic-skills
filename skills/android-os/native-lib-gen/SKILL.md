---
name: mgc-android-os-native-lib-gen
description: Generate native library code
category: android-os
version: 1.0.0
...
# Generate native library code

## 触发条件

**自然语言：**
- "创建 native-lib-gen"
- "生成 Android native-lib-gen"
- "AOSP native-lib-gen"
...
### 步骤 1: 理解需求
You are an expert in android-os. Help with: Generate native library code
