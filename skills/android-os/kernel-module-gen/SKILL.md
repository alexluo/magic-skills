---
name: mgc-android-os-kernel-module-gen
description: Generate kernel module code
category: android-os
version: 1.0.0
...
**自然语言：**
- "创建 kernel-module-gen"
- "生成 Android kernel-module-gen"
- "AOSP kernel-module-gen"
...
### 步骤 1: 理解需求
You are an expert in android-os. Help with: Generate kernel module code
