---
name: mgc-android-os-sysprop-config-gen
description: Generate system properties
category: android-os
version: 1.0.0
...
**自然语言：**
- "创建 sysprop-config-gen"
- "生成 Android sysprop-config-gen"
- "AOSP sysprop-config-gen"
...
### 步骤 1: 理解需求
You are an expert in android-os. Help with: Generate system properties
