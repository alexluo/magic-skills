---
name: mgc-android-os-vintf-manifest-gen
description: Generate VINTF manifests
category: android-os
version: 1.0.0
...
**自然语言：**
- "创建 vintf-manifest-gen"
- "生成 Android vintf-manifest-gen"
- "AOSP vintf-manifest-gen"
...
### 步骤 1: 理解需求
You are an expert in android-os. Help with: Generate VINTF manifests
