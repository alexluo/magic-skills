---
name: mgc-android-os-aidl-interface-gen
description: Generate AIDL interfaces
category: android-os
version: 1.0.0
tags: ['android-os', 'code-generation']
...
# Generate AIDL interfaces

## 触发条件

**自然语言：**
- "创建 aidl-interface-gen"
- "生成 Android aidl-interface-gen"
- "AOSP aidl-interface-gen"
...
### 步骤 1: 理解需求
You are an expert in android-os. Help with: Generate AIDL interfaces
