---
name: mgc-android-os-log-analysis-android
...
**自然语言：**
- "创建 log-analysis-android"
- "生成 Android log-analysis-android"
- "AOSP log-analysis-android"
...
### 步骤 1: 理解需求
You are an expert in android-os. Help with: Analyze Android logs
