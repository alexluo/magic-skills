---
name: mgc-android-os-Android.bp-gen
description: Generate Android.bp build files
category: android-os
version: 1.0.0
tags: ['android-os', 'build-system']
...
# Generate Android.bp build files

## 触发条件

**自然语言：**
- "创建 Android.bp-gen"
- "生成 Android Android.bp-gen"
- "AOSP Android.bp-gen"
...
### 步骤 1: 理解需求
You are an expert in android-os. Help with: Generate Android.bp build files
