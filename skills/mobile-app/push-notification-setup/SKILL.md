---
name: mgc-mobile-app-push-notification-setup
description: Setup push notifications
category: mobile-app
version: 1.0.0
tags: ['mobile-app', 'messaging']
...
**自然语言：**
- "创建 push-notification-setup"
- "生成 push-notification-setup"
...
### 步骤 1: 理解需求
You are an expert in mobile-app. Help with: Setup push notifications
