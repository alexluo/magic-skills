---
name: mgc-mobile-app-swiftui-view-gen
description: Generate SwiftUI views
category: mobile-app
version: 1.0.0
tags: ['mobile-app', 'ui-generation']
...
### 步骤 1: 理解需求
You are an expert in mobile-app. Help with: Generate SwiftUI views
