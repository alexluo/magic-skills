---
name: mgc-mobile-app-localization-setup
description: Setup localization
category: mobile-app
version: 1.0.0
tags: ['mobile-app', 'internationalization']
...
**自然语言：**
- "创建 localization-setup"
- "生成 localization-setup"
- "iOS/Android localization-setup"
...
### 步骤 1: 理解需求
You are an expert in mobile-app. Help with: Setup localization
