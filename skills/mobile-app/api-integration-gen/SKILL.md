---
name: mgc-mobile-app-api-integration-gen
description: Generate API integration code
category: mobile-app
version: 1.0.0
tags: ['mobile-app', 'networking']
...
**自然语言：**
- "创建 api-integration-gen"
- "生成 api-integration-gen"
- "iOS/Android api-integration-gen"
...
### 步骤 1: 理解需求
You are an expert in mobile-app. Help with: Generate API integration code
