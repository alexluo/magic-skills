---
name: mgc-mobile-app-local-storage-gen
description: Generate local storage code
category: mobile-app
version: 1.0.0
tags: ['mobile-app', 'persistence']
...
**自然语言：**
- "创建 local-storage-gen"
- "生成 local-storage-gen"
- "iOS/Android local-storage-gen"
...
### 步骤 1: 理解需求
You are an expert in mobile-app. Help with: Generate local storage code
