---
name: mgc-mobile-app-login-feature-gen
description: Generate login feature code
category: mobile-app
version: 1.0.0
tags: ['mobile-app', 'feature-generation']
...
# Generate login feature code

## 触发条件

**自然语言：**
- "创建 login-feature-gen"
- "生成 login-feature-gen"
- "iOS/Android login-feature-gen"
...
### 步骤 1: 理解需求
You are an expert in mobile-app. Help with: Generate login feature code
