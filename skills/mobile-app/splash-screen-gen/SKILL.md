---
name: mgc-mobile-app-splash-screen-gen
...
**自然语言：**
- "创建 splash-screen-gen"
- "生成 splash-screen-gen"
- "iOS/Android splash-screen-gen"
...
### 步骤 1: 理解需求
You are an expert in mobile-app. Help with: Generate splash screens
