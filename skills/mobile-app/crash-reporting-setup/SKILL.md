---
name: mgc-mobile-app-crash-reporting-setup
description: Setup crash reporting
category: mobile-app
version: 1.0.0
...
**自然语言：**
- "创建 crash-reporting-setup"
- "生成 crash-reporting-setup"
- "iOS/Android crash-reporting-setup"
...
### 步骤 1: 理解需求
You are an expert in mobile-app. Help with: Setup crash reporting
