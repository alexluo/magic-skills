---
name: mgc-mobile-app-accessibility-check
description: Check accessibility
category: mobile-app
version: 1.0.0
tags: ['mobile-app', 'quality']
...
**自然语言：**
- "创建 accessibility-check"
- "生成 accessibility-check"
- "iOS/Android accessibility-check"
...
### 步骤 1: 理解需求
You are an expert in mobile-app. Help with: Check accessibility
