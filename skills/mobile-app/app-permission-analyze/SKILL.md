---
name: mgc-mobile-app-app-permission-analyze
description: Analyze app permissions
category: mobile-app
version: 1.0.0
...
**自然语言：**
- "创建 app-permission-analyze"
- "生成 app-permission-analyze"
- "iOS/Android app-permission-analyze"
...
### 步骤 1: 理解需求
You are an expert in mobile-app. Help with: Analyze app permissions
