---
name: mgc-mobile-app-deep-link-config
description: Configure deep links
category: mobile-app
version: 1.0.0
...
### 步骤 1: 理解需求
You are an expert in mobile-app. Help with: Configure deep links
