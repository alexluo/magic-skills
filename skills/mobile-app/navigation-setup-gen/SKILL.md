---
name: mgc-mobile-app-navigation-setup-gen
description: Generate navigation setup
category: mobile-app
version: 1.0.0
...
**自然语言：**
- "创建 navigation-setup-gen"
- "生成 navigation-setup-gen"
- "iOS/Android navigation-setup-gen"
...
### 步骤 1: 理解需求
You are an expert in mobile-app. Help with: Generate navigation setup
