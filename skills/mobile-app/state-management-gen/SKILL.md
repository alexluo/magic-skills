---
name: mgc-mobile-app-state-management-gen
...
**自然语言：**
- "创建 state-management-gen"
- "生成 state-management-gen"
- "iOS/Android state-management-gen"
...
### 步骤 1: 理解需求
You are an expert in mobile-app. Help with: Generate state management code
