---
name: mgc-mobile-app-performance-monitoring
...
**自然语言：**
- "创建 performance-monitoring"
- "生成 performance-monitoring"
- "iOS/Android performance-monitoring"
...
### 步骤 1: 理解需求
You are an expert in mobile-app. Help with: Setup performance monitoring
