---
name: mgc-mobile-app-ui-test-gen-android
description: Generate Android UI tests
category: mobile-app
version: 1.0.0
...
**自然语言：**
- "创建 ui-test-gen-android"
- "生成 ui-test-gen-android"
- "iOS/Android ui-test-gen-android"
...
### 步骤 1: 理解需求
You are an expert in mobile-app. Help with: Generate Android UI tests
