---
name: mgc-mobile-app-unit-test-gen-mobile
description: Generate mobile unit tests
category: mobile-app
version: 1.0.0
...
**自然语言：**
- "创建 unit-test-gen-mobile"
- "生成 unit-test-gen-mobile"
- "iOS/Android unit-test-gen-mobile"
...
### 步骤 1: 理解需求
You are an expert in mobile-app. Help with: Generate mobile unit tests
