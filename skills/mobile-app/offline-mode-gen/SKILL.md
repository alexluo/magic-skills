---
name: mgc-mobile-app-offline-mode-gen
description: Generate offline mode code
category: mobile-app
version: 1.0.0
...
### 步骤 1: 理解需求
You are an expert in mobile-app. Help with: Generate offline mode code
