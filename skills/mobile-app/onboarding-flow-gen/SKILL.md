---
name: mgc-mobile-app-onboarding-flow-gen
description: Generate onboarding flows
category: mobile-app
version: 1.0.0
tags: ['mobile-app', 'ux']
...
**自然语言：**
- "创建 onboarding-flow-gen"
- "生成 onboarding-flow-gen"
- "iOS/Android onboarding-flow-gen"
...
### 步骤 1: 理解需求
You are an expert in mobile-app. Help with: Generate onboarding flows
