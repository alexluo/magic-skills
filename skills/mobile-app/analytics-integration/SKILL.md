---
name: mgc-mobile-app-analytics-integration
description: Integrate analytics
category: mobile-app
version: 1.0.0
tags: ['mobile-app', 'tracking']
...
**自然语言：**
- "创建 analytics-integration"
- "生成 analytics-integration"
- "iOS/Android analytics-integration"
...
### 步骤 1: 理解需求
You are an expert in mobile-app. Help with: Integrate analytics
